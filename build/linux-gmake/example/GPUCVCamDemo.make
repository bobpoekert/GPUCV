...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/linux-gmake/x32/Debug/GPUCVCamDemo
  TARGETDIR  = ../../../lib/linux-gmake/x32/Debug
  TARGET     = $(TARGETDIR)/GPUCVCamDemo32D
  DEFINES   += -D__LINUX__ -D_LINUX -D_EXE -D_GPUCV_SUPPORT_SWITCH -D_SG_TLS_SUPPORT_GL -D__x86_32__ -DDEBUG -D_DEBUG
  INCLUDES  += -I../../../src/example/GPUCVCamDemo -I../../../dependencies/SugoiTools/include -I../../../dependencies/SugoiTools/dependencies/include -I/usr/include -I/usr/local/include -I/usr/local/include/opencv -I/usr/include/opencv -I../../../include -I../../../dependencies/include -I../../../src/lib -I../../../src/plugin
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/linux-gmake/x32/Release/GPUCVCamDemo
  TARGETDIR  = ../../../lib/linux-gmake/x32/Release
  TARGET     = $(TARGETDIR)/GPUCVCamDemo32
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/linux-gmake/x64/Debug/GPUCVCamDemo
  TARGETDIR  = ../../../lib/linux-gmake/x64/Debug
  TARGET     = $(TARGETDIR)/GPUCVCamDemo64D
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/linux-gmake/x64/Release/GPUCVCamDemo
  TARGETDIR  = ../../../lib/linux-gmake/x64/Release
  TARGET     = $(TARGETDIR)/GPUCVCamDemo64
...
OBJECTS := \
	$(OBJDIR)/bg_substraction.o \
	$(OBJDIR)/morphology.o \
	$(OBJDIR)/arithm.o \
	$(OBJDIR)/lut.o \
	$(OBJDIR)/StdAfx.o \
	$(OBJDIR)/GpuCVCamDemo.o \
	$(OBJDIR)/sobel.o \
	$(OBJDIR)/deriche.o \
...
$(OBJDIR)/bg_substraction.o: ../../../src/example/GPUCVCamDemo/bg_substraction.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/morphology.o: ../../../src/example/GPUCVCamDemo/morphology.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/arithm.o: ../../../src/example/GPUCVCamDemo/arithm.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/lut.o: ../../../src/example/GPUCVCamDemo/lut.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/StdAfx.o: ../../../src/example/GPUCVCamDemo/StdAfx.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/GpuCVCamDemo.o: ../../../src/example/GPUCVCamDemo/GpuCVCamDemo.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/sobel.o: ../../../src/example/GPUCVCamDemo/sobel.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
$(OBJDIR)/deriche.o: ../../../src/example/GPUCVCamDemo/deriche.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(CXXFLAGS) -o $@ -c $<
