...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/linux-gmake/x32/Debug/simple_c_integration
  TARGETDIR  = ../../../lib/linux-gmake/x32/Debug
  TARGET     = $(TARGETDIR)/simple_c_integration32D
  DEFINES   += -D__LINUX__ -D_LINUX -D_EXE -D_GPUCV_SUPPORT_SWITCH -D_SG_TLS_SUPPORT_GL -D__x86_32__ -DDEBUG -D_DEBUG
  INCLUDES  += -I../../../src/example/simple_c_integration -I../../../dependencies/SugoiTools/include -I../../../dependencies/SugoiTools/dependencies/include -I/usr/include -I/usr/local/include -I/usr/local/include/opencv -I/usr/include/opencv -I../../../include -I../../../dependencies/include -I../../../src/lib -I../../../src/plugin
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/linux-gmake/x32/Release/simple_c_integration
  TARGETDIR  = ../../../lib/linux-gmake/x32/Release
  TARGET     = $(TARGETDIR)/simple_c_integration32
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/linux-gmake/x64/Debug/simple_c_integration
  TARGETDIR  = ../../../lib/linux-gmake/x64/Debug
  TARGET     = $(TARGETDIR)/simple_c_integration64D
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/linux-gmake/x64/Release/simple_c_integration
  TARGETDIR  = ../../../lib/linux-gmake/x64/Release
  TARGET     = $(TARGETDIR)/simple_c_integration64
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking simple_c_integration
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning simple_c_integration
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
...
$(OBJDIR)/StdAfx.o: ../../../src/example/simple_c_integration/StdAfx.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o $@ -c $<
$(OBJDIR)/simple_c_integration.o: ../../../src/example/simple_c_integration/simple_c_integration.c
	@echo $(notdir $<)
	$(SILENT) $(CC) $(CFLAGS) -o $@ -c $<
